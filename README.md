# 🕳️ Bunkers Anywhere by ZEnicko (Build 42)

[🇪🇸 Leer en Español](#español)

Ever found the perfect safehouse to survive the apocalypse but it lacked a secure basement? Or maybe you wanted to hide your underground base by covering the stairwell? With **Bunkers Anywhere** you can now seal almost any staircase in the game and turn it into your own personal hidden bunker!

---

## 🌟 Main Features

*   **🛠️ The "Bunker Kit":** A new item you can find while exploring. By using it on any wooden or generic staircase in the game, your character will dismantle the structure, fill the open gap with a high-quality persistent wooden floor, and install an interactive manhole cover.
...
*   Hardware Stores
*   General Tool Store Shelves
*   Army Surplus Locations
*   Mechanic Shops and Car Supply areas
*   Gigamart (Hardware section)
...
<a name="español"></a>
# 🕳️ Bunkers Anywhere by ZEnicko (Build 42) - Español

¿Alguna vez has encontrado el refugio perfecto para sobrevivir al apocalipsis pero le faltaba un sótano seguro, o te habría gustado ocultar tu base subterránea tapando el hueco de las escaleras? ¡Con **Bunkers Anywhere** ahora puedes sellar cualquier escalera del juego y convertirla en tu propio búnker personal oculto!

---

## 🌟 Características Principales

*   **🛠️ El "Kit de Bunker":** Un nuevo objeto que puedes encontrar explorando. Al usarlo sobre cualquier escalera de madera o genérica del juego, tu personaje desmantelará mágicamente el armatoste, rellenará el hueco abierto con un piso de madera persistente de alta calidad, e instalará una tapa de alcantarilla interactiva.
...
*   Estantes de Herramientas Generales (Tool Stores)
*   Surplus Militares (Army Surplus)
*   Talleres de Mecánica y Recambios de Coches
*   Gigamart (Zona de Ferretería)
